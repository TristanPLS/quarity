...
> Dernière mise à jour : 2026-06-10 (**B6 livré : CRUD complet 20 endpoints** puis **B7 livré : boucle de matching → `alert_events`** — voir les entrées. Pour mémoire : durcissement post-analyse #28–#33 mergé les 2026-06-08→09 ; 2026-06-07 = Jalon 3 axe BDD clos B1–B5).
