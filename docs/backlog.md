...
- [ ] **B8b** *(reliquat ops, post-MVP)* : arrêt gracieux explicite des tâches de fond (CancellationToken matching + abonné), limite de connexions WS par org, métriques (clients connectés, pushs/s, drops).
